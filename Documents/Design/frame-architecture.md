...
| `implement-test` | always | `agents/Test-Writer.agent.md` for hub flow; `skills/test-driven-development/adapters/implement-test-adapter.md` for `/spine-run` | `changeset.touchesTestableCode()` | `skills/test-driven-development/adapters/implement-test-auto-na-adapter.md` — `not changeset.touchesTestableCode()` | `skills/test-driven-development/adapters/implement-test-explicit-skip-adapter.md` |
...
| `implement-docs` | always | `agents/Doc-Keeper.agent.md` for hub flow; `skills/documentation-finalization/adapters/implement-docs-adapter.md` for `/spine-run` | `changeset.changesBehaviorOrInterface()` | `skills/documentation-finalization/adapters/implement-docs-auto-na-adapter.md` — `not changeset.changesBehaviorOrInterface()` | `skills/documentation-finalization/adapters/implement-docs-explicit-skip-adapter.md` |
...
credits:
  ...
  - port: review
    ...
    integrity-check:
      expected-prosecution-passes: [1, 2, 3, 4, 5]
      observed-prosecution-passes: [1, 2, 3, 4, 5]
      passed: true
...
‡ **`implement-test` — split declaration state (#612)**: Code-Conductor hub flow retains the legacy `agents/Test-Writer.agent.md` work declaration. The `/spine-run` surface now discovers the skill-as-adapter work declaration at `skills/test-driven-development/adapters/implement-test-adapter.md`. Auto-N/A and explicit-skip predicate adapters remain unchanged; runtime `/spine-run` exercise for this port is deferred to #641.

§ **`implement-docs` — split declaration state (#612)**: Code-Conductor hub flow retains the legacy `agents/Doc-Keeper.agent.md` work declaration. The `/spine-run` surface now discovers the skill-as-adapter work declaration at `skills/documentation-finalization/adapters/implement-docs-adapter.md`. Auto-N/A and explicit-skip predicate adapters remain unchanged; runtime `/spine-run` exercise for this port is deferred to #641.
