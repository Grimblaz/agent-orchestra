...
- source: "Code Conductor Agent"
  ...
  action: "Preserve as the conductor-level outcome contract for any /orchestrate -> /spine-run switch. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
...
- source: "ownership-principles / Ownership Principles"
  ...
  disposition: spine-runner-keeps
  action: "Keep as a runtime quality gate before PR creation and completion reporting. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Ownership Principles"
  ...
  disposition: spine-runner-keeps
  action: "Keep goal-check authority in the conductor that dispatches and evaluates specialists. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Ownership Principles"
  ...
  disposition: spine-runner-keeps
  action: "Keep pre-dispatch reality checks in the frame walker before each executable slice. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Ownership Principles"
  ...
  disposition: spine-runner-keeps
  action: "Keep structured decision prompts as a conductor invariant for authority-boundary pauses. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Ownership Principles"
  ...
  disposition: spine-runner-keeps
  action: "Keep question-channel enforcement in the runtime shell for all conductor pauses. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "D-rules D1-D14 / Questioning & Pause Policy (Mandatory)"
  ...
  disposition: spine-runner-keeps
  action: "Preserve as runtime guardrails around all D-rule checkpoints and branch decisions. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Model-Switch Checkpoint (Authorized Hub-Mode Pause)"
  ...
  disposition: spine-runner-keeps
  action: "Keep the D9 checkpoint in hub-mode orchestration; later verification should compare against Spine-Runner pause behavior. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Review Workflow Interruption Budget (Balanced Policy)"
  ...
  disposition: spine-runner-keeps
  action: "Keep interruption-budget accounting in review-loop orchestration. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Continuation Contract (Mandatory)"
  ...
  disposition: spine-runner-keeps
  action: "Keep continuation enforcement as a top-level conductor invariant. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Overview"
  ...
  disposition: spine-runner-keeps
  action: "Keep dispatch announcement and specialist delegation in the frame-walking runtime. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Overview"
  ...
  disposition: spine-runner-keeps
  action: "Preserve no-direct-editing as a conductor-shell capability boundary. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Plan Creation Strategy"
  ...
  disposition: spine-runner-keeps
  action: "Keep runtime plan-reality reconciliation before slice dispatch. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Step protocols Step 0-5 / Core Workflow / Hub Execution Workflow"
  ...
  disposition: spine-runner-keeps
  action: "Preserve Step 0 ordering in any frame-walker entry path. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Hub Mode + Smart Resume"
  ...
  disposition: spine-runner-keeps
  action: "Keep hub-mode detection and /orchestrate equivalence in the entry shell that launches Spine-Runner. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Mode + Smart Resume"
  ...
  disposition: spine-runner-keeps
  action: "Keep marker-based smart resume in orchestration; verify against session-memory-contract and issue comment lookup behavior later. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Scope Classification Gate"
  ...
  disposition: spine-runner-keeps
  action: "Keep the authority-bound tier choice in hub orchestration before upstream dispatch. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Scope Classification Gate"
  ...
  disposition: spine-runner-keeps
  action: "Keep tier override capture in the hub-mode decision prompt and downstream phase matrix. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Scope Classification Gate"
  ...
  disposition: spine-runner-keeps
  action: "Keep post-plan escalation handling in hub orchestration; planner owns producing escalation metadata. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Scope Classification Gate"
  ...
  disposition: spine-runner-keeps
  action: "Keep hub execution-order selection in the orchestration runtime. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Downstream Ownership Boundary"
  ...
  disposition: spine-runner-keeps
  action: "Keep pre-edit ownership classification as a fail-closed runtime gate before mutation. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Downstream Ownership Boundary"
  ...
  disposition: spine-runner-keeps
  action: "Keep mid-run ownership reclassification in the runner before any new mutation delegation. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Downstream Ownership Boundary"
  ...
  disposition: spine-runner-keeps
  action: "Keep repository-awareness in the downstream ownership gate. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Downstream Ownership Boundary"
  ...
  disposition: spine-runner-keeps
  action: "Keep durable handoff writes constrained to D9 pause handling. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "D9 Model-Switch Checkpoint (Hub Mode Only)"
  ...
  disposition: spine-runner-keeps
  action: "Keep exact D9 option labels and timing in hub-mode runtime. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "D9 Model-Switch Checkpoint (Hub Mode Only)"
  ...
  disposition: spine-runner-keeps
  action: "Keep normalized durable-handoff comparison in D9 orchestration; verify against SMC behavior in a later step. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "D9 Model-Switch Checkpoint (Hub Mode Only)"
  ...
  disposition: spine-runner-keeps
  action: "Keep D9 suppression checks in hub-mode smart resume. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Branch Authority Gate"
  ...
  disposition: spine-runner-keeps
  action: "Keep branch authority proof collection in the runtime before branch mutation commands. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Branch Authority Gate"
  ...
  disposition: spine-runner-keeps
  action: "Keep mismatch reconciliation as a blocking branch-mutation gate. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Branch Authority Gate"
  ...
  disposition: spine-runner-keeps
  action: "Keep same-tip duplicate handling in branch-mutation safety checks. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Multi-Issue Bundling"
  ...
  disposition: spine-runner-keeps
  action: "Keep per-issue smart resume and scope classification in bundled hub orchestration. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Multi-Issue Bundling"
  ...
  disposition: spine-runner-keeps
  action: "Keep single-prompt bundle tier confirmation in hub-mode orchestration. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Multi-Issue Bundling"
  ...
  disposition: spine-runner-keeps
  action: "Keep bundle orchestration and plan-memory naming in the runtime; planner owns bundled plan content. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Hub Execution Workflow / Locate Plan & Context"
  ...
  disposition: spine-runner-keeps
  action: "Keep plan lookup and latest-comment selection in the runner entry sequence. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Locate Plan & Context"
  ...
  disposition: spine-runner-keeps
  action: "Keep design-context lookup and fallback cache creation in session recovery handling. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Locate Plan & Context"
  ...
  disposition: spine-runner-keeps
  action: "Keep read-only supporting-context discovery in the runtime before dispatch. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Locate Plan & Context"
  ...
  disposition: spine-runner-keeps
  action: "Keep no-plan branching in the runner; plan generation remains Issue-Planner-owned. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Locate Plan & Context / D12 Commit policy detection"
  ...
  disposition: spine-runner-keeps
  action: "Keep D12 commit-policy detection in plan-load initialization. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Determine Resume Point & Validate Plan"
  ...
  disposition: spine-runner-keeps
  action: "Keep step-resume scanning in the frame walker before dispatch. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Determine Resume Point & Validate Plan / D13 Step commit reconciliation"
  ...
  disposition: spine-runner-keeps
  action: "Keep D13 session-memory/git reconciliation in resume handling; step commit execution itself delegates to skills/step-commit/SKILL.md. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Determine Resume Point & Validate Plan"
  ...
  disposition: spine-runner-keeps
  action: "Keep plan-reality verification in the runtime before step execution. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Hub Execution Workflow / Execute Each Step"
  ...
  disposition: spine-runner-keeps
  action: "Keep dispatch-cost accumulator lifecycle with pipeline metrics runtime state. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Execute Each Step"
  ...
  disposition: spine-runner-keeps
  action: "Keep spine fallback prompts and dispatch-fallback-events emission in the frame walker. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Execute Each Step"
  ...
  disposition: spine-runner-keeps
  action: "Keep the prompt-once and suppression decision in conductor runtime; use skills/copilot-cost-collection/SKILL.md only for setup semantics after the runtime offers collection. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Execute Each Step"
  ...
  disposition: spine-runner-keeps
  action: "Keep dispatch announcement and focused-prompt construction in the runner. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Execute Each Step"
  ...
  disposition: spine-runner-keeps
  action: "Keep post-dispatch inspection and corrective re-delegation in orchestration. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Execute Each Step"
  ...
  disposition: spine-runner-keeps
  action: "Keep design-alignment checkpoints in the runner before refactor, review, and CE Gate phases. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Hub Execution Workflow / Execute Each Step"
  ...
  disposition: spine-runner-keeps
  action: "Keep RC conformance evaluation and correction-cycle routing in the conductor runtime until an adapter exists. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Hub Execution Workflow / Execute Each Step"
  ...
  disposition: spine-runner-keeps
  action: "Keep SMC progress annotation in runtime state management after each validated step. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Hub Execution Workflow / Create PR Step 4"
  ...
  disposition: spine-runner-keeps
  action: "Keep end-to-end issue-resolution review as the PR readiness gate. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Hub Execution Workflow / Create PR Step 4"
  ...
  disposition: spine-runner-keeps
  action: "Keep PR-scope and migration scan evidence gathering in the final readiness gate. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Hub Execution Workflow / Create PR Step 4"
  ...
  disposition: spine-runner-keeps
  action: "Keep PR creation and required PR-body assembly in the conductor runtime. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Hub Execution Workflow / Report Completion Step 5"
  ...
  disposition: spine-runner-keeps
  action: "Keep completion reporting coupled to a created PR URL or structured stop condition. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Agent Selection table"
  ...
  disposition: spine-runner-keeps
  action: "Keep Explore vs Research-Agent selection as a dispatch policy until routing-tables owns an equivalent selector. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Agent Selection table"
  ...
  disposition: spine-runner-keeps
  action: "Keep documentation batch self-check requirements in dispatch prompt construction. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Review Reconciliation Loop (Mandatory)"
  ...
  disposition: spine-runner-keeps
  action: "Keep review-loop orchestration and GitHub-trigger routing in the runtime shell. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Validation Ladder (Mandatory) / Validation Ladder tiers"
  ...
  disposition: spine-runner-keeps
  action: "Keep validation orchestration around adapter-provided tier methodology in the frame runner. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "CE Gate orchestration / Customer Experience Gate (CE Gate)"
  ...
  disposition: spine-runner-keeps
  action: "Keep CE Gate placement in Tier 4 orchestration. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "BDD pre-flight / Customer Experience Gate (CE Gate)"
  ...
  disposition: spine-runner-keeps
  action: "Keep BDD pre-flight extraction and recovery option labels in CE Gate orchestration; future adapter verification may cite skills/bdd-scenarios/SKILL.md if ownership moves. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "CE Gate orchestration / Customer Experience Gate (CE Gate)"
  ...
  disposition: spine-runner-keeps
  action: "Keep runner-dispatch branching in CE Gate orchestration until a dedicated CE adapter owns it. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "CE Gate orchestration / Customer Experience Gate (CE Gate)"
  ...
  disposition: spine-runner-keeps
  action: "Keep CE Gate evidence formatting and result marker emission in PR-body assembly. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "PR Body Pipeline Metrics"
  ...
  disposition: spine-runner-keeps
  action: "Keep metrics-block presence as a PR body assembly invariant. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Pipeline metrics emission / Pipeline Metrics"
  ...
  disposition: spine-runner-keeps
  action: "Keep dispatch-cost sample flush and targeted back-fill in metrics emission orchestration. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Tactical Adaptation"
  ...
  disposition: spine-runner-keeps
  action: "Keep bounded tactical adaptation in the runner so execution follows reality while preserving scope. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Tactical Adaptation"
  ...
  disposition: spine-runner-keeps
  action: "Keep authority-bound tactical escalation in orchestration with recommended options. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
...
- source: "Context Management for Long Sessions"
  ...
  disposition: spine-runner-keeps
  action: "Keep compaction timing and state-survival assumptions in long-session orchestration. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Context Management for Long Sessions"
  ...
  disposition: spine-runner-keeps
  action: "Keep concrete compaction-summary construction in the runtime shell. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Handoff to User"
  ...
  disposition: spine-runner-keeps
  action: "Keep user-handoff policy coupled to PR creation and structured authority-bound pauses. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Handoff to User"
  ...
  disposition: spine-runner-keeps
  action: "Keep escalation prompt construction in the conductor runtime. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Best Practices"
  ...
  disposition: spine-runner-keeps
  action: "Keep review-output sequencing in review-loop orchestration. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
- source: "Best Practices"
  ...
  disposition: spine-runner-keeps
  action: "Keep prompt-size discipline and dispatch announcement in the frame runner. Replay verification is tracked in https://github.com/Grimblaz/agent-orchestra/issues/592."
  verification_status: replay-pending-merged-pr
  reverification-trigger: "issue:#592"
  verified-against-sha: ""
  verified-via-pr-sha: ""
