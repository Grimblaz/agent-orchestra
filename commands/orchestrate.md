...
1. Resolve the issue context from the arguments. Accept a single issue number, an issue URL, or a multi-issue bundle. If the arguments do not identify at least one issue, ask for one.
