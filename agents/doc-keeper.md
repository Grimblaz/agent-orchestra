...
After loading, follow everything under its `## Core Principles`, `## Overview`, `## Plan Tracking`, `## Core Responsibilities`, `## Documentation Maintenance Responsibilities`, and `## Skills Reference` sections.
