...
After loading, follow everything under its `## Core Principles`, `## Overview`, `## 🎯 Proactive Hunting Stance`, `## 🚨 CRITICAL: Integration Gaps Are NOT Tech Debt`, `## Plan Tracking`, `## Refactoring Checklist`, and `## Skills Reference` sections.
