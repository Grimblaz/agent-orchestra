...
| `skills/*/adapters/{port}-adapter.md` | `agents/*.agent.md` | Agent tool dispatch | Single-variant work adapter path; pass adapter path as adapter/port-skill input |
