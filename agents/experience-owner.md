...
After loading, follow everything under its `## Core Principles`, `## Role`, `## Process`, `## GitHub Setup`, `## Safe-Operations Compliance`, `## Upstream Phase`, `## Update Issue with Customer Framing`, `## Upstream Completion Gate`, `## Downstream Phase`, `## Graceful Degradation`, and `## Boundaries` sections.
