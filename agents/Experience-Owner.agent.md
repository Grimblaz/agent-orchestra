...
Load `skills/customer-experience/SKILL.md`. If a `## BDD Framework` **line-start heading** (column 0, not a backticked mention) exists in `copilot-instructions.md`, also load `skills/bdd-scenarios/SKILL.md`.
