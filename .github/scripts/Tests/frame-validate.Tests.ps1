        ...
        $script:GetFrameValidateExpectedProviderDeclarationKeys = {
            $expectedDeclarationsByRole = @{
                'work'          = [ordered]@{
                    ...
                    'skills/documentation-finalization/adapters/implement-docs-adapter.md' = 'implement-docs'
                    'skills/implementation-discipline/adapters/implement-code-adapter.md' = 'implement-code'
                    'skills/test-driven-development/adapters/implement-test-adapter.md' = 'implement-test'
