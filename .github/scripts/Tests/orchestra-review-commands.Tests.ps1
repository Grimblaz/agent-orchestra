...
Describe 'orchestra-review command contract' {
    ...
    It 'documents body-load recovery for the redundant full-review prosecution passes' {
        ...
        $content | Should -Match '(?is)(?:quorum|survive|at least.{0,60}generalist.{0,120}specialist|enough valid passes remain|enough passes remain|remaining passes)' -Because '/orchestra:review must say the pipeline continues only when the quorum requirement is met (at least 1 generalist and 1 specialist survive)'
    }
