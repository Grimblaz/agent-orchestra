...
Pass the repo-relative adapter path as the adapter evidence by setting `-AdapterName 'skills/implementation-discipline/adapters/implement-code-adapter.md'`, and include validation evidence from the build-test cycle.
