...
> Note: ## Composite References above is the complete list for this directory and is what the promotion check reads. This older grouping is kept for its per-file commentary and does not include `references/test-authoring-exhibits.md`.
